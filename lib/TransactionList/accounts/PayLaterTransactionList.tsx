...
const PayLaterTransactionList: React.FC<IPayLaterTransactionList> = ({
  ...
  const groups = payLaterTransaction.reduce((groups: any, transaction: any) => {
  ...
  const groupsByMonth = payLaterTransaction.reduce(
  ...
  return (
    ...
    >
      {groupArraysByMonth.map((groupByMonth: any) => {
        return (
          <>
            <div className="flex flex-row justify-between items-center text-onPrimaryContainer p-2 bg-onPrimary roundediner">
