...
const ModalShowTransactionDesktop: React.FC<IModalShowTransaction> = ({
  ...
  return (
    <motion.div
      className="h-[100vh] max-h-[100vh] overflow-y-auto w-fit bg-onPrimary dark:bg-onBackground fixed right-0 top-0 flex flex-col gap-10 border-l-4 border-gray-500 pb-10"
