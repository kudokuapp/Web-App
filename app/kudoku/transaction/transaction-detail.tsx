        ...
        <div className="flex flex-col w-5/12 gap-4">
          ...
          <div className="flex flex-col justify-between gap-2 p-4 mt-2">
            <h4 className="text-outline text-sm">
              ...
              {/* {formatDate(
                new Date(transactionDetail.dateTimestamp)
                  .toISOString()
                  .split('T')[0]
              )} */}
            </h4>
            ...
            <div className="flex flex-row justify-between">
              <h4>{transactionDetail.category[0].name}</h4>
              <h4>{transactionDetail.category[0].amount}</h4>
            </div>
          </div>
          <div className="flex flex-col justify-between gap-2 p-4 mt-2">
            <h4 className="text-outline text-sm">Category</h4>
            <p>{transactionDetail.category[0].name}</p>
          </div>
